...
# define VM
Add-LabDiskDefinition -Name Data -DiskSizeInGb 100 -Label 'System' -DriveLetter D -AllocationUnitSize 64kb

Add-LabMachineDefinition -Name $VMName -Memory 6GB -DiskSizeInGb 100 -Disk Data -Network $defaultNetworkSwitch -OperatingSystem 'Windows Server 2019 Standard (Desktop Experience)'
